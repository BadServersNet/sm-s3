...
static void TestHashes()
{
	...
	Expect(
		"hmac rfc4231 case 2",
		s3::ToHex(s3::HmacSha256("Jefe", "what do ya want for nothing?")),
...
static void TestUri()
{
	...
	s3::QueryParams const params = { { "prefix", "runs/" }, { "list-type", "2" } };
...
static void TestHeaderSignature()
{
	...
	Expect(
		"aws get object canonical request hash",
		s3::Sha256Hex(output.canonicalRequest),
		"7344ae5b7ee6c3e7e6b0fe0640412a37625d1fbfff95c48bbb2dc43964946972"
	);
	Expect(
		"aws get object signature", output.signature, "f0e8bdb87c964420e857bd35b5d6ed310bd44f0170aba48dd91039c6036bdb41"
	);
	Expect(
		"aws get object authorization",
